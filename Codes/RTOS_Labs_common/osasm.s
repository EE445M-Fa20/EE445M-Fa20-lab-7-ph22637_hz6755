...
;	LDR		R0,=RunPt
;	LDR		R1,[R0]
;	STR		SP,[R1]			;Save current SP to current TCB.SavedSP 
;	LDR		R1,[R1,#4]		;The pointer points to the next TCB
;	STR		R1,[R0]			;Point RunPt to next TCB
;	LDR		SP,[R1]			;Load next TCB.SavedSP to SP register
;	POP		{R0-R12,LR}
;	CPSIE	I
;    BX      LR

...
void ST7735_Message(uint32_t d, uint32_t l, char *pt, int32_t value){
  // write this as part of Labs 1 and 2
	...
	if (*pt != NULL){
		if(d == 0){
		ST7735_DrawString( 0,l+8*d,pt,ST7735_Color565(220, 20, 60));
		}
		else{
		ST7735_DrawString( 0,l+8*d,pt,ST7735_Color565(0, 128, 128));
		}
	}
	else{}
	
	ST7735_SetCursor(strlen(pt),l+8*d);
